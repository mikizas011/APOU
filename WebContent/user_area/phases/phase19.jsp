		...
		<div class = "contentWrapper white">
			<div id="body">
				...
				<%	String estadoFase[] = (String[])request.getAttribute("estadoFase");
					PhaseTexto p = (PhaseTexto)request.getAttribute("phase19");
				%>
				...
				<div class="phase">
					...
					<input type="hidden" name="id" >
						<div class="phases">
							<ul>
								...
								<li class="actual" title="Justificación del cumplimiento de las determinaciones de la ordenación territorial"><a <%if(p.getFase() >= 9){ %>onclick="transferCallToServlet(19, <%=request.getSession().getAttribute("idPlan")%>)"<%} %>>Fase 19</a></li>
					...
					<div class="content">
						...
						<h1>Justificación del cumplimiento de las determinaciones de la ordenación territorial</h1>
