		...
		<div class = "contentWrapper white">
			<div id="body">
				...
				<%	String estadoFase[] = (String[])request.getAttribute("estadoFase");
					PhaseTexto p = (PhaseTexto)request.getAttribute("phase11");
				%>
					...
					<input type="hidden" name="id" >
						<div class="phases">
							<ul>
								...
								<li class="actual" title="Introducción"><a <%if(p.getFase() >= 9){ %>onclick="transferCallToServlet(11, <%=request.getSession().getAttribute("idPlan")%>)"<%} %>>Fase 11</a></li>
