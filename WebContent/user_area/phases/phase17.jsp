		...
		<div class = "contentWrapper white">
			<div id="body">
				...
				<%	String estadoFase[] = (String[])request.getAttribute("estadoFase");
					PhaseTexto p = (PhaseTexto)request.getAttribute("phase17");
				%>
				...
				<div class="phase">
					...
					<input type="hidden" name="id" >
						<div class="phases">
							<ul>
								...
								<li class="actual" title="Descripción de la ordenación propuesta"><a <%if(p.getFase() >= 9){ %>onclick="transferCallToServlet(17, <%=request.getSession().getAttribute("idPlan")%>)"<%} %>>Fase 17</a></li>
					...
					<div class="content">
						...
						<h1>Descripción de la ordenación propuesta</h1>
