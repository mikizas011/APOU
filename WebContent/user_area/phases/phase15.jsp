		...
		<div class = "contentWrapper white">
			<div id="body">
				...
				<%	String estadoFase[] = (String[])request.getAttribute("estadoFase");
					PhaseTexto p = (PhaseTexto)request.getAttribute("phase15");
				%>
					...
					<input type="hidden" name="id" >
						<div class="phases">
							<ul>
								...
								<li class="actual" title="Tramitación"><a <%if(p.getFase() >= 9){ %>onclick="transferCallToServlet(15, <%=request.getSession().getAttribute("idPlan")%>)"<%} %>>Fase 15</a></li>
